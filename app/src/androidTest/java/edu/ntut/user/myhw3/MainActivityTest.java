...
//        mTxtNumFamily = (TextView) mMainActivity.findViewById(R.id.txtNumFamily);
    ...
    public void maleAgeRange1Family12() {
        //male, age<30, family number=12  結果應為，還不急
        String sugStr = mMainActivity.getString(R.string.suggestion) + mMainActivity.getString(R.string.sug_not_hurry);
        ...
        assertEquals(sugStr, mTxtSug.getText().toString());
    }

    @Test
    public void maleAgeRange2Family5() {
        //male, 30<=age<=40, family number=5  結果應為，開始找對象
        String sugStr = mMainActivity.getString(R.string.suggestion) + mMainActivity.getString(R.string.sug_find_couple);
    ...
    public void maleAgeRange3Family3() {
        //male, 40<age, family number=3  結果應為，開始找對象
        String sugStr = mMainActivity.getString(R.string.suggestion) + mMainActivity.getString(R.string.sug_find_couple);
    ...
    public void femaleAgeRange1Family3() {
        //female, age<28, family number=3  結果應為，趕快結婚
        String sugStr = mMainActivity.getString(R.string.suggestion) + mMainActivity.getString(R.string.sug_get_married);
    ...
    public void femaleAgeRange2Family5() {
        //female, 30<=age<=40, family number=5  結果應為，開始找對象
        String sugStr = mMainActivity.getString(R.string.suggestion) + mMainActivity.getString(R.string.sug_find_couple);
    ...
    public void femaleAgeRange3Family8() {
        //female, 40<age, family number=8  結果應為，趕快結婚
        String sugStr = mMainActivity.getString(R.string.suggestion) + mMainActivity.getString(R.string.sug_get_married);
